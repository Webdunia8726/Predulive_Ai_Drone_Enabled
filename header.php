...
<html lang="zxx">
  <head>
    ...
    />
    <!-- Title -->
    <title>Predulive Labs | Idea to innovation</title>
    <!-- Google Fonts -->
    <link
  ...
  <body>
    ...
    <div class="techSoft-preloader">
      ...
      <div class="loader-text" style="color:#ff561d ;">Idea To Innovation</div>
    </div>
      ...
      <div class="techSoft-responsive-nav techSoft-fixed-nav">
        <div class="container">
          <div class="techSoft-responsive-menu">
            <div class="logo">
              <a href="index.php">
                <img src="assets/img/homepage/pixelcut-export.png" alt="logo" />
              </a>
            </div>
          </div>
        </div>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-item">
                      <a href="Company.php" class="nav-link">About Us</a>
                    </li>
                    <li class="nav-item">
                      <a href="casestudy.php" class="nav-link"
                        >Case Studies</a
                      >
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item">
                      <a href="dronelab.php" class="nav-link">Drone Lab</a>
                    </li>
                  </ul>
                </li>

                <div class="other-option">
                  <a class="btn btn-primary mr-15" href="requestdemo.php">Get In Touch</a>
                </div>
              </ul>
            </div>
          </nav>
